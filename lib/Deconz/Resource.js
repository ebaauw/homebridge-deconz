    ...
    switch (this.manufacturer) {
      ...
      case 'LUMI':
        switch (this.model) {
          ...
          case 'lumi.switch.l1aeu1': // Xiaomi Aqara H1
          case 'lumi.switch.n1aeu1': // Xiaomi Aqara H1
            buttons.push([1, 'Button', SINGLE | DOUBLE])
            break
          case 'lumi.ctrl_ln2.aq1':
          case 'lumi.sensor_86sw2': // Xiaomi wall switch (two buttons)
          case 'lumi.switch.l2aeu1': // Xiaomi Aqara H2
          case 'lumi.switch.n2aeu1': // Xiaomi Aqara H2
