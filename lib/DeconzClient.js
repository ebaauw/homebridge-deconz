...
class DeconzClient extends homebridgeLib.HttpClient {
  ...
  /** Create a new instance of a DeconzClient.
    ...
    * `params.apiKey`.
    * If no API key is known {@link DeconzClient#getApiKey getApiKey()} can
  ...
  /** Obtain an API key and set {@link DeconzClient#apiKey apiKey}.
    *
  ...
  async getApiKey (application) {
    ...
    try {
      ...
      this.apiKey = response.success.apiKey
      return this.apiKey
    } catch (error) {
      this.apiKey = apiKey
      throw (error)
  ...
  /** Delete the API key and clear {@link DeconzClient#apiKey apiKey}.
    * @throws {HttpError} In case of HTTP error.
    * @throws {DeconzError} In case of API error.
    */
  async deleteApiKey () {
  ...
  /** Initiate a touchlink scan.
    ...
    * `/api/`_API_key_`/touchlink/scan`, to initiate a touchlink scan.
    ...
    * `/api/`_API_key_`/touchlink/`_ID_`/identify`.
    * To issue a touchlink reset, issue a POST request to
    * `/api/`_API_key_`/touchlink/`_ID_`/reset`.
    * @return {DeconzResponse} response - The response.
    * @throws {HttpError} In case of HTTP error.
    * @throws {DeconzError} In case of API error.
    */
